...
class CommonField:
    ...
    DL_TPUT_MBPS = 'dl_tput_mbps'
    UL_TPUT_MBPS = 'ul_tput_mbps'
    TPUT_CLASS = 'throughput_class'
...
class MptcpField:
    TPUT_AVAILABILITY = 'tput_availability' 
    TPUT_DIFF_STABILITY = 'tput_diff_stability'
    TPUT_DIFF_MAGNITUDE = 'tput_diff_magnitude'
